 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <a class="btn btn-success navbar-right btn-xs" href="/admin/course_config_add/<?php echo $type;?>">新增</a>
                    ...
                    <tbody>
                     <?php foreach ($instrument as $key=>$val){?>
                      <tr>
                        ...
                        <td>
                            <a href="/admin/course_config_add/<?php echo $type;?>/<?php echo $val->id;?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>&nbsp;修改</a>
 ...
 $(function(){
  $('.delete_configs').click(function(){
    ...
    if(confirm('您确定要删除此条数据吗？')){
      var submitData = {id:jd_id,table:'course_config'};
