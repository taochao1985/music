 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <a class="btn btn-success navbar-right btn-xs" href="/admin/student_add">新增</a>
                    ...
                    <tbody>
                      <?php foreach ($teachers as $key=>$val){?>
							<tr>
								 ...
								 <td><a href="/admin/teacher_add/<?php echo $val->id;?>" class="edit_configs">修改</a>
								 &nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:void(0)" class="delete_configs" data_id="<?php echo $val->id;?>">删除</a></td>
							</tr>
						<?php }?>
