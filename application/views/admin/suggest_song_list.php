 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <a class="btn btn-success navbar-right btn-xs" href="/admin/suggest_song_add">新增</a>
                    ...
                    <tbody>
                      <?php foreach ($class as $key=>$val){?>
                            <tr>
                                 ...
                                 <td><a href="/admin/suggest_song_add/<?php echo $val->id;?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>&nbsp;修改</a>
