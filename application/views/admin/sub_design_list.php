	...
	<table class="table table-hover table-striped" style="font-size:11px;clear:both;">
		...
		<?php foreach ($store as $key=>$val){?>
			<tr>
				 ...
				 <td><a href="/admin/store_add/<?php echo $val->id;?>">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:void(0)" class="delete_configs" data_id="<?php echo $val->id;?>">删除</a></td>
			</tr>
		<?php }?>
...
<?php  $this->load->view('admin/pagination',array('current_page'=>$current_page,'total'=>$total,'url'=>'/admin/store_list/'));?>
